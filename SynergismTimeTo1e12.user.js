...
window.timeTo1e12Diamonds = (waitTime = 10, locale="pl-PL") => {
  ...
  setTimeout(() => {
    ...
    const dRate = (diamondsNow - diamondsStart) / waitTime;
    ...
    const atTime = new Date(Date.now() + secTo1e12 * 1000).toLocaleString(locale);
    console.log(
